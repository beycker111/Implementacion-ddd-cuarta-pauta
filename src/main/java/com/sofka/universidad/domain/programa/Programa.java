...
import com.sofka.universidad.domain.programa.events.*;
import com.sofka.universidad.domain.programa.values.*;
...
public class Programa extends AggregateEvent<ProgramaId> {
    ...
    public void agregarCursoAlPensum(CursoId cursoId, Nombre nombre, Credito credito){
        appendChange(new CursoAgregado(cursoId, nombre, credito)).apply();
    }
